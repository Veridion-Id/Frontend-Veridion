...
export type VerificationType = 'google' | 'github' | 'linkedin' | 'discord' | 'government-id' | 'binance' | 'phone-verification' | 'email-verification' | 'biometrics' | 'proof-clean-hands' | 'stellar-transactions';
